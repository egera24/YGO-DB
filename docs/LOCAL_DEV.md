...
| R2 bucket `ygo-cardmarket`, key `archives/{YYYY}/{MM}/{DD}/{HHMM}/catalog_archive.zip` | Raw JSON archive (ZIP_LZMA) |
| R2 bucket `ygo-cardmarket`, key `archives/{YYYY}/{MM}/{DD}/{HHMM}/sync_price_log.log.br` | Job log (Brotli) |
| R2 bucket `ygo-cardmarket`, key `archives/{YYYY}/{MM}/{DD}/{HHMM}/sync_price_report.json.br` | Pipeline report (Brotli) |
| R2 bucket `ygo-cardmarket`, key `archives/{YYYY}/{MM}/{DD}/{HHMM}/cardmarket_prices.zip` | Matched export archive for GHA re-import |

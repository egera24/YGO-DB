...
| Service | Purpose |
|---------|---------|
| **Render prod keep-alive** | **cron-job.org** POST → GHA cold wake ~07:50 Budapest + daytime GET every 10 min 08:00–22:00. Staging not pinged. See **[render-keepalive.md](render-keepalive.md)**. |
